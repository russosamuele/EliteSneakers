...
<%
	 ...
	 <header>
        ...
        <ul class="navbar">
            <li><a href="<%=path%>/common/index2.jsp">Home</a></li>
		...
		<div class="nav-icon">
			...
			<a href="<%=path%>/admin/management.jsp"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="whiteSmoke" class="bi bi-person-gear" viewBox="0 0 16 16">
