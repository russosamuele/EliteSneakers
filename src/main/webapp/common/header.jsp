	...
	<header>
		...
		<nav>
			<ul>
				...
				if (isLogged && !isAdmin) {
				%>
				<li><a href="<%=path%>/common/index.jsp">
				...
				<li><a href="<%=path%>/common/catalog.jsp">
				...
				<li><a href="<%=path%>/common/cart.jsp"> <svg
				...
				<li><a href="<%=path%>/common/account.jsp"> <svg
							xmlns="http://www.w3.org/2000/svg" width="30" height="30"
				...
				<li><a href="<%=path%>/admin/management.jsp">
				...
				<li><a href="<%=path%>/common/login.jsp"> <svg
							xmlns="http://www.w3.org/2000/svg" width="30" height="30"
							fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
  							<path
								d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
